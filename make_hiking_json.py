...
# 1. 설정 (폴더명 확인 필수!)
image_dir = 'images/result_hiking'  # 사진이 들어있는 폴더
json_output = 'data/hiking.json'    # 만들어질 결과 파일
...
if not os.path.exists(image_dir):
    ...
    with open(json_output, 'w', encoding='utf-8') as f:
        json.dump(hiking_list, f, ensure_ascii=False, indent=2)

    print(f"✅ 성공! {len(hiking_list)}장의 사진 정보를 {json_output}에 담았습니다.")
